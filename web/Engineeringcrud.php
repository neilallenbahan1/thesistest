...
<?php require_once 'Engineeringprocess.php'; ?>
...
?>
    ...
    $result = $mysqli->query("SELECT * FROM engr") or die ($mysqli->error);
    //pre_r($result);
    ...
    <?php
            ...
            <tr>
               ...
               <td>
                    <a class="edit" href = "Engineeringcrud.php?edit=<?php echo $row['id']?>"
                            class = "btn- btn-info"><img src="crudedit.png" /></a>
                    <a class="delete"  href = "Engineeringcrud.php?delete=<?php echo $row['id']?>"
    ...
    <form class="from1"action ="Engineeringcrud.php" method ="POST">  
