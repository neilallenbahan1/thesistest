...
<div class="dropdown show dr">
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
    ...
    <a class="dropdown-item" href="HospitalityManagementcrud.php">HospitalityManagement</a>
    ...
    <a class="dropdown-item" href="ComputerSciencecrud.php">ComputerScience</a>
...
<?php require_once 'CustomsAdministrationprocess.php'; ?>
...
?>
    ...
    $result = $mysqli->query("SELECT * FROM ca") or die ($mysqli->error);
    //pre_r($result);
    ...
    <?php
            ...
            <tr>
               ...
               <td>
                    <a class="edit" href = "CustomsAdministrationcrud.php?edit=<?php echo $row['id']?>"
                            class = "btn- btn-info"><img src="crudedit.png" /></a>
                    <a class="delete"  href = "CustomsAdministrationcrud.php?delete=<?php echo $row['id']?>"
    ...
    <form class="from1"action ="CustomsAdministrationcrud.php" method ="POST">  
