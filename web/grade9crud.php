...
<?php require_once 'grade9process.php'; ?>
...
?>
    ...
    $result = $mysqli->query("SELECT * FROM grade9") or die ($mysqli->error);
    //pre_r($result);
    ...
    <?php
            ...
            <tr>
               ...
               <td>
                    <a class="edit" href = "grade9crud.php?edit=<?php echo $row['id']?>"
                            class = "btn- btn-info"><img src="crudedit.png" /></a>
                    <a class="delete"  href = "grade9crud.php?delete=<?php echo $row['id']?>"
    ...
    <form class="from1"action ="grade9crud.php" method ="POST">  
