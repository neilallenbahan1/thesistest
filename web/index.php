...
<body>
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
    ...
    <a class="dropdown-item" href="elementaryindex.php">Elementary</a>
    <a class="dropdown-item" href="highschoolindex.php">Highschool</a>
    <a class="dropdown-item" href="collegeindex.php">College</a>
  </div>
</div>
...
<i class="fa fa-search s-btn" aria-hidden="true"></i> 
        ...
        <h4 class="Title">Elementary</h4>
        <div class="row">
          
        <?php
    $result = mysqli_query($con,"SELECT *
    FROM elementarytease
          ...
          while($row = mysqli_fetch_assoc($result)){
              ...
              <div class='col-lg-4 col-md-6 col-sm-6 col-6 mb-8 elementarytease'>
                  ...
                  <input type='hidden' name='pcode' value=".$row['pcode']." />
                    <td><a href ='elementaryteaseinfoindex.php?title=".$row['pname']."'</td>  
  ...
  <button   type='submit' class='Seemore'>See more</button>
    ...
    <?php echo $status; ?>
        ...
        <h4 class="Title">Junior&SeniorHigh</h4>
        <div class="row">
