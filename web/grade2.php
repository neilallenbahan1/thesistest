...
<body>
  ...
  <a class="dropdown-item" href="elementary.php">Grade1</a>
  <a class="dropdown-item" href="grade3.php">Grade3</a>
    <a class="dropdown-item" href="grade4.php">Grade4</a>
    <a class="dropdown-item" href="grade5.php">Grade5</a>
    <a class="dropdown-item" href="grade6.php">Grade6</a>
  </div>
</div>
    ...
    $result = mysqli_query($con,"SELECT * FROM `grade2`");
             ...
             while($row=$result->fetch_assoc()): ?>
              ...
              <div class="col-lg-4 col-md-6 col-sm-6 col-6 mb-8 elementarytease">
                  <div class="card h-90">
                  <?php  echo  "<td><a href ='grade2info.php?title=".$row['pname']."'</td>  "; ?>
