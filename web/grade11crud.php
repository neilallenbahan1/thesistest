...
<?php require_once 'grade11process.php'; ?>
...
?>
    ...
    $result = $mysqli->query("SELECT * FROM grade11") or die ($mysqli->error);
    //pre_r($result);
    ...
    <?php
            ...
            <tr>
               ...
               <td>
                    <a class="edit" href = "grade11crud.php?edit=<?php echo $row['id']?>"
                            class = "btn- btn-info"><img src="crudedit.png" /></a>
                    <a class="delete"  href = "grade11crud.php?delete=<?php echo $row['id']?>"
    ...
    <form class="from1"action ="grade11crud.php" method ="POST">  
