...
<?php include('paypaldelrecord.php') ?>
...
.registerbtn{
    ...
    <div class="container" style="margin-top:80px;">
            ...
            <form method="post" action="paypaldelrecord.php">
         ...
         <form>
                ...
                <label>Adviser</label>
                <input  type = "text" id="testvirtual" class = "jQKeyboard form-control" name="Adviser" placeholder="" value="<?php echo $Adviser; ?>"/>
...
<label></label>
                <input  type = "hidden" id="testvirtual" class = "jQKeyboard form-control" name="totalpaid" placeholder="" value=" <?php
foreach ($_SESSION["shopping_cart"] as $product){
