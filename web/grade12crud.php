...
<?php require_once 'grade12process.php'; ?>
...
?>
    ...
    $result = $mysqli->query("SELECT * FROM grade12") or die ($mysqli->error);
    //pre_r($result);
    ...
    <?php
            ...
            <tr>
               ...
               <td>
                    <a class="edit" href = "grade12crud.php?edit=<?php echo $row['id']?>"
                            class = "btn- btn-info"><img src="crudedit.png" /></a>
                    <a class="delete"  href = "grade12crud.php?delete=<?php echo $row['id']?>"
    ...
    <form class="from1"action ="grade12crud.php" method ="POST">  
