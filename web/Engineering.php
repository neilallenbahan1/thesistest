...
<body>
  ...
  <a class="dropdown-item" href=" college.php"> Business&Accountancy</a>  
    <a class="dropdown-item" href="HospitalityManagement.php">HospitalityManagement</a>  
    <a class="dropdown-item" href="CustomsAdministration.php">CustomsAdministration</a>
    <a class="dropdown-item" href="Criminaljustice.php">Criminaljustice</a>
    <a class="dropdown-item" href=" LiberalArts.php">LiberalArts</a>
    <a class="dropdown-item" href="ComputerScience.php">ComputerScience</a>
    <a class="dropdown-item" href="TeacherEducation.php">TeacherEducation</a>
  </div>
</div>
    ...
    $result = mysqli_query($con,"SELECT * FROM `engr` ");
             ...
             while($row=$result->fetch_assoc()): ?>
              ...
              <div class="col-lg-4 col-md-6 col-sm-6 col-6 mb-8 elementarytease">
                  <div class="card h-90">
                  <?php  echo  "<td><a href ='Engineeringinfo.php?title=".$row['pname']."'</td>  "; ?>
