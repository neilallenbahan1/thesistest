...
$result = mysqli_query(
$con,
"SELECT * FROM `engr` WHERE `pcode`='$code'"
);
...
<body>
  ...
  <a class="dropdown-item" href=" collegeindex.php"> Business&Accountancy</a>  
...
<i class="fa fa-search s-btn" aria-hidden="true"></i> 
        ...
        <?php
    $result = mysqli_query($con,"SELECT * FROM `engr` ");
             ...
             while($row=$result->fetch_assoc()): ?>
              ...
              <div class="col-lg-4 col-md-6 col-sm-6 col-6 mb-8 elementarytease">
                  <div class="card h-90">
                  <?php  echo  "<td><a href ='Engineeringinfoindex.php?title=".$row['pname']."'</td>  "; ?>
