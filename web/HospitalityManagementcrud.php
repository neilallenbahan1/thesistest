...
<?php require_once 'HospitalityManagementprocess.php'; ?>
...
?>
    ...
    $result = $mysqli->query("SELECT * FROM hm") or die ($mysqli->error);
    //pre_r($result);
    ...
    <?php
            ...
            <tr>
               ...
               <td>
                    <a class="edit" href = "HospitalityManagementcrud.php?edit=<?php echo $row['id']?>"
                            class = "btn- btn-info"><img src="crudedit.png" /></a>
                    <a class="delete"  href = "HospitalityManagementcrud.php?delete=<?php echo $row['id']?>"
    ...
    <form class="from1"action ="HospitalityManagementcrud.php" method ="POST">  
