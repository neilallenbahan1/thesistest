...
$result = mysqli_query(
$con,
"SELECT * FROM `bsm` WHERE `pcode`='$code'"
);
...
<body>
  ...
  <a class="dropdown-item" href="HospitalityManagementindex.php">HospitalityManagement</a>
    <a class="dropdown-item" href="CustomsAdministrationindex.php">CustomsAdministration</a>
    <a class="dropdown-item" href="CriminalJusticeindex.php">CriminalJustice</a>
    <a class="dropdown-item" href="LiberalArtsindex.php">LiberalArts</a>
    <a class="dropdown-item" href="ComputerScienceindex.php">ComputerScience</a>
    <a class="dropdown-item" href="Engineeringindex.php">Engineering</a>
    <a class="dropdown-item" href="TeacherEducationindex.php">TeacherEducation</a>
  </div>
</div>
...
<i class="fa fa-search s-btn" aria-hidden="true"></i> 
        ...
        <?php
    $result = mysqli_query($con,"SELECT * FROM `bsm` ");

          
    
             while($row=$result->fetch_assoc()): ?>

              <div class="col-lg-4 col-md-6 col-sm-6 col-6 mb-8 elementarytease">
                  <div class="card h-90">
                  <?php  echo  "<td><a href ='Business&Accountancyinfoindex.php?title=".$row['pname']."'</td>  "; ?>
