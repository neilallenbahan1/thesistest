...
<nav class="navbar navbar-expand-lg navbar-custom z-depth-half sticky-top">
    <div class="container">
      ...
      <li ><a class="category elemen" href="admin.php">Elementary</a></li>
...
<div class="dropdown show dr">
  ...
  <a class="dropdown-item" href="admin.php">Grade1</a> 
    <a class="dropdown-item" href="grade2crud.php">Grade2</a>
    <a class="dropdown-item" href="grade3crud.php">Grade3</a>
    <a class="dropdown-item" href="grade4crud.php">Grade4</a>
    <a class="dropdown-item" href="grade6crud.php">Grade6</a>
  </div>
</div>

<?php require_once 'grade5process.php'; ?>
...
?>
    ...
    $result = $mysqli->query("SELECT * FROM grade5") or die ($mysqli->error);
    //pre_r($result);
    ...
    <?php
            ...
            <tr>
               ...
               <td>
                    <a class="edit" href = "grade5crud.php?edit=<?php echo $row['id']?>"
                            class = "btn- btn-info"><img src="crudedit.png" /></a>
                    <a class="delete"  href = "grade5crud.php?delete=<?php echo $row['id']?>"
    ...
    <form class="from1"action ="grade5crud.php" method ="POST">  
