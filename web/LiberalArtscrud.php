...
<?php require_once 'LiberalArtsprocess.php'; ?>
...
?>
    ...
    $result = $mysqli->query("SELECT * FROM la") or die ($mysqli->error);
    //pre_r($result);
    ...
    <?php
            ...
            <tr>
               ...
               <td>
                    <a class="edit" href = "LiberalArtscrud.php?edit=<?php echo $row['id']?>"
                            class = "btn- btn-info"><img src="crudedit.png" /></a>
                    <a class="delete"  href = "LiberalArtscrud.php?delete=<?php echo $row['id']?>"
    ...
    <form class="from1"action ="LiberalArtscrud.php" method ="POST">  
