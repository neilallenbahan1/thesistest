...
<body>
                              ...
                              <?php
                                    ...
                                    if (!empty($_SESSION["shopping_cart"])) {
                                        $cart_count = count(array_keys($_SESSION["shopping_cart"])); ?>
                                         <div class="cart_div">
                                            <a href="shoopcart.php"><img src="cart-icon1.png" /><span class= "numbercart">
                                                <?php echo $cart_count; ?> Item</span></a>
                                         </div>
                              <?php
                                    }else{   ?>     
                                 
                                       <img src="cart-icon1.png" /><span>                                           
                                <?php  }
                                  ?>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-3">
        ...
        <h1 class="my-3">Elementary</h1>
        <div class="w3-dropdown-hover">
  <button class="w3-button">Grade4</button>
 ...
 $sql = "SELECT * FROM grade4 WHERE pname ='$title'";
