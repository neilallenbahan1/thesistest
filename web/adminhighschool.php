...
<nav class="navbar navbar-expand-lg navbar-custom z-depth-half sticky-top">
    <div class="container">
      ...
      <li ><a class="category elemen" href="#">Junior&SeniorHigh</a></li>
      <li class="nav-item" style="border-right: 0.1rem solid lightgrey">
            
            </li>
      <li ><a class="category" href="admincollege.php">College</a></li>
...
<div class="dropdown show dr">
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
    ...
    <a class="dropdown-item" href="grade8crud.php">Grade8</a>
    <a class="dropdown-item" href="grade9crud.php">Grade9</a>
    <a class="dropdown-item" href="grade10crud.php">Grade10</a>
    <a class="dropdown-item" href="grade11crud.php">Grade11</a>
    <a class="dropdown-item" href="grade12crud.php">Grade12</a>
  </div>
</div>

<?php require_once 'adminhighschoolprocess.php'; ?>
...
?>
    ...
    $result = $mysqli->query("SELECT * FROM grade7") or die ($mysqli->error);
    //pre_r($result);
    ...
    <?php
            ...
            <tr>
               ...
               <td>
                    <a class="edit" href = "adminhighschool.php?edit=<?php echo $row['id']?>"
                            class = "btn- btn-info"><img src="crudedit.png" /></a>
                    <a class="delete"  href = "adminhighschool.php?delete=<?php echo $row['id']?>"
    ...
    <form class="from1"action ="adminhighschool.php" method ="POST">  
