...
<?php require_once 'CriminialJusticeprocess.php'; ?>
...
?>
    ...
    $result = $mysqli->query("SELECT * FROM cj") or die ($mysqli->error);
    //pre_r($result);
    ...
    <?php
            ...
            <tr>
               ...
               <td>
                    <a class="edit" href = "CriminialJusticecrud.php?edit=<?php echo $row['id']?>"
                            class = "btn- btn-info"><img src="crudedit.png" /></a>
                    <a class="delete"  href = "CriminialJusticecrud.php?delete=<?php echo $row['id']?>"
    ...
    <form class="from1"action ="CriminialJusticecrud.php" method ="POST">  
