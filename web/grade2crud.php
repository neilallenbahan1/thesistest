...
<?php require_once 'grade2process.php'; ?>
...
?>
    ...
    $result = $mysqli->query("SELECT * FROM grade2") or die ($mysqli->error);
    //pre_r($result);
    ...
    <?php
            ...
            <tr>
               ...
               <td>
                    <a class="edit" href = "grade2crud.php?edit=<?php echo $row['id']?>"
                            class = "btn- btn-info"><img src="crudedit.png" /></a>
                    <a class="delete"  href = "grade2crud.php?delete=<?php echo $row['id']?>"
    ...
    <form class="from1"action ="grade2crud.php" method ="POST">  
