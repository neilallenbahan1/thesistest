...
<nav class="navbar navbar-expand-lg navbar-custom z-depth-half sticky-top">
    <div class="container">
      ...
      <li ><a class="category" href="#">College</a></li>
...
<?php require_once 'grade3process.php'; ?>
...
?>
    ...
    $result = $mysqli->query("SELECT * FROM grade3") or die ($mysqli->error);
    //pre_r($result);
    ...
    <?php
            ...
            <tr>
               ...
               <td>
                    <a class="edit" href = "grade3crud.php?edit=<?php echo $row['id']?>"
                            class = "btn- btn-info"><img src="crudedit.png" /></a>
                    <a class="delete"  href = "grade3crud.php?delete=<?php echo $row['id']?>"
    ...
    <form class="from1"action ="grade3crud.php" method ="POST">  
