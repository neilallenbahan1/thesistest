...
<div class="dropdown show dr">
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
    ...
    <a class="dropdown-item" href="Engineeringecrud.php">Engineering</a>
  </div>
</div>

<?php require_once 'TeacherEducationprocess.php'; ?>
...
?>
    ...
    $result = $mysqli->query("SELECT * FROM te") or die ($mysqli->error);
    //pre_r($result);
    ...
    <?php
            ...
            <tr>
               ...
               <td>
                    <a class="edit" href = "TeacherEducationcrud.php?edit=<?php echo $row['id']?>"
                            class = "btn- btn-info"><img src="crudedit.png" /></a>
                    <a class="delete"  href = "TeacherEducationcrud.php?delete=<?php echo $row['id']?>"
    ...
    <form class="from1"action ="TeacherEducationcrud.php" method ="POST">  
