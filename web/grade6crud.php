...
<?php require_once 'grade6process.php'; ?>
...
?>
    ...
    $result = $mysqli->query("SELECT * FROM grade6") or die ($mysqli->error);
    //pre_r($result);
    ...
    <?php
            ...
            <tr>
               ...
               <td>
                    <a class="edit" href = "grade6crud.php?edit=<?php echo $row['id']?>"
                            class = "btn- btn-info"><img src="crudedit.png" /></a>
                    <a class="delete"  href = "grade6crud.php?delete=<?php echo $row['id']?>"
    ...
    <form class="from1"action ="grade6crud.php" method ="POST">  
