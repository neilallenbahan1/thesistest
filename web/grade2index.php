...
$result = mysqli_query(
$con,
"SELECT * FROM `grade2` WHERE `pcode`='$code'"
);
...
<body>
  ...
  <a class="dropdown-item" href="elementaryindex.php">Grade1</a>
  <a class="dropdown-item" href="grade3index.php">Grade3</a>
    <a class="dropdown-item" href="grade4index.php">Grade4</a>
    <a class="dropdown-item" href="grade5index.php">Grade5</a>
    <a class="dropdown-item" href="grade6index.php">Grade6</a>
  </div>
</div>
...
<i class="fa fa-search s-btn" aria-hidden="true"></i> 
        ...
        <?php
    $result = mysqli_query($con,"SELECT * FROM `grade2`");
             ...
             while($row=$result->fetch_assoc()): ?>
              ...
              <div class="col-lg-4 col-md-6 col-sm-6 col-6 mb-8 elementarytease">
                  <div class="card h-90">
                  <?php  echo  "<td><a href ='grade2infoindex.php?title=".$row['pname']."'</td>  "; ?>
