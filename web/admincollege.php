...
<?php require_once 'admincollegeprocess.php'; ?>
...
?>
    ...
    $result = $mysqli->query("SELECT * FROM bsm") or die ($mysqli->error);
    //pre_r($result);
    ...
    <?php
            ...
            <tr>
               ...
               <td>
                    <a class="edit" href = "admincollege.php?edit=<?php echo $row['id']?>"
                            class = "btn- btn-info"><img src="crudedit.png" /></a>
                    <a class="delete"  href = "admincollege.php?delete=<?php echo $row['id']?>"
    ...
    <form class="from1"action ="admincollege.php" method ="POST">  
