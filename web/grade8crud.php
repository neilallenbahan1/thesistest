...
<?php require_once 'grade8process.php'; ?>
...
?>
    ...
    $result = $mysqli->query("SELECT * FROM grade8") or die ($mysqli->error);
    //pre_r($result);
    ...
    <?php
            ...
            <tr>
               ...
               <td>
                    <a class="edit" href = "grade8crud.php?edit=<?php echo $row['id']?>"
                            class = "btn- btn-info"><img src="crudedit.png" /></a>
                    <a class="delete"  href = "grade8crud.php?delete=<?php echo $row['id']?>"
    ...
    <form class="from1"action ="grade8crud.php" method ="POST">  
