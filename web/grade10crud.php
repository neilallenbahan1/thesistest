...
<div class="dropdown show dr">
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
    ...
    <a class="dropdown-item" href="adminhighschool.php">Grade7</a>
...
<?php require_once 'grade10process.php'; ?>
...
?>
    ...
    $result = $mysqli->query("SELECT * FROM grade10") or die ($mysqli->error);
    //pre_r($result);
    ...
    <?php
            ...
            <tr>
               ...
               <td>
                    <a class="edit" href = "grade10crud.php?edit=<?php echo $row['id']?>"
                            class = "btn- btn-info"><img src="crudedit.png" /></a>
                    <a class="delete"  href = "grade10crud.php?delete=<?php echo $row['id']?>"
    ...
    <form class="from1"action ="grade10crud.php" method ="POST">  
