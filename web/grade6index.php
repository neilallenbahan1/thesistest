...
$result = mysqli_query(
$con,
"SELECT * FROM `grade6` WHERE `pcode`='$code'"
);
...
<body>
  ...
  <a class="dropdown-item" href="grade2index.php">Grade2</a>
...
<i class="fa fa-search s-btn" aria-hidden="true"></i> 
        ...
        <?php
    $result = mysqli_query($con,"SELECT * FROM `grade6`");
             ...
             while($row=$result->fetch_assoc()): ?>
              ...
              <div class="col-lg-4 col-md-6 col-sm-6 col-6 elementarytease">
                  <div class="card h-90">
                  <?php  echo  "<td><a href ='grade6infoindex.php?title=".$row['pname']."'</td>  "; ?>
