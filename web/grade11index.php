...
$result = mysqli_query(
$con,
"SELECT * FROM `grade11` WHERE `pcode`='$code'"
);
...
<body>
  ...
  <a class="dropdown-item" href="highschoolindex.php">Grade7</a>
    <a class="dropdown-item" href="grade8index.php">Grade8</a>
    <a class="dropdown-item" href="grade9index.php">Grade9</a>
    <a class="dropdown-item" href="grade10index.php">Grade10</a>
    <a class="dropdown-item" href="grade12index.php">Grade12</a>
  </div>
</div>
...
<i class="fa fa-search s-btn" aria-hidden="true"></i> 
        ...
        <?php
    $result = mysqli_query($con,"SELECT * FROM `grade11`");
             ...
             while($row=$result->fetch_assoc()): ?>
              ...
              <div class="col-lg-4 col-md-6 col-sm-6 col-6 elementarytease">
                  <div class="card h-90">
                  <?php  echo  "<td><a href ='grade11infoindex.php?title=".$row['pname']."'</td>  "; ?>
