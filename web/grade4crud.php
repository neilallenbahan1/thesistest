...
<div class="dropdown show dr">
  ...
  <a class="dropdown-item" href="admin.php">Grade1</a> 
    ...
    <a class="dropdown-item" href="grade5crud.php">Grade5</a>
    <a class="dropdown-item" href="grade6crud.php">Grade6</a>
  </div>
</div>

<?php require_once 'grade4process.php'; ?>
...
?>
    ...
    $result = $mysqli->query("SELECT * FROM grade4") or die ($mysqli->error);
    //pre_r($result);
    ...
    <?php
            ...
            <tr>
               ...
               <td>
                    <a class="edit" href = "grade4crud.php?edit=<?php echo $row['id']?>"
                            class = "btn- btn-info"><img src="crudedit.png" /></a>
                    <a class="delete"  href = "grade4crud.php?delete=<?php echo $row['id']?>"
    ...
    <form class="from1"action ="grade4crud.php" method ="POST">  
